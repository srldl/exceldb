...
let obj =  {  "dataRows": dataRows,
              ...
              "headers_tooltip": ["project acronym should not exceed 5 letters","subproject name","start date","event name"],
...
- headers_tooltip: Header field elaborations if you need to explain the header meaning further to the user.
